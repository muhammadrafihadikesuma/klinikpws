                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input id="id_suratsakit" name="id_suratsakit" type="hidden" class="form-control" />
                                ...
                                <div class="col-12"></div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingTensi"  placeholder="Umur" readonly>
                                ...
                                <div class="col-12"></div>
                                <div class="form-floating mb-3">
                                    <input type="time" class="form-control" id="floatingBerat" value="<?php echo $jam ?>" placeholder="Masukkan Berat Badan" required>
                                ...
                                <div class="col-12"></div>
                                <div class="form-floating mb-3">
                                    <input type="date" class="form-control" id="floatingPernafasan" name="pernafasan" value="<?php echo $pernafasan ?>" placeholder="Masukkan Pernafasan" required>
