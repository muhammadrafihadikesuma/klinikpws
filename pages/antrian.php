                        ...
                        <div class="card-body">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    <?php
                                    require "../api/koneksi.php";
                                    $sql = mysqli_query($koneksi, "SELECT * FROM tbl_pendaftaran WHERE status='antri' ORDER BY id_pendaftaran  Desc LIMIT 200") or die("error karena" . mysqli_error($koneksi));
                                    $no = 1;
                                    ...
                                    ?>
                                        <tr style="font-size:12px;" ;>
                                            ...
                                            <td style="width:4%; text-align:center;">
                                                <a href="sekred.php?page=proses_update_antri&id=<?php echo $id; ?>" class="label label-sm label-info"> Periksa</a>
